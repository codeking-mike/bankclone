...
<body>
    ...
    <?php include_once('header.php'); ?>
        ...
        <section class="bg-blue-800 border-b-2 border-white">
            ...
            <div class="px-6 space-y-0 md:space-y-0 bg-blue-800 text-white">
                ...
                <div class="flex flex-col md:flex-col justify-between items-center py-12">
                    ...
                    <h4 class="font-bold text-2xl">Quick Transfer</h4>
        ...
        <section class="bg-gray-100 pb-32">
                ...
                <div class="px-2 py-4 w-full md:py-4 md:w-2/3">
                    <h4 class="font-bold text-blue-700 text-left p-2 text-xl"><i class="ri-arrow-left-right-fill h-12 w-12"></i>&nbsp;&nbsp;Make a Quick Transfer</h4>
  ...
  <div class="py-6 px-6">
    ...
    <div class="border-b border-gray-900/10 pb-12">
      ...
      <div class="mt-10 gap-x-6 gap-y-8 sm:grid-cols-6">
        ...
        <div class="mt-2 border">
            ...
            <?php
                                 $sql = "SELECT * FROM beneficiaries WHERE ben_type='local'";
            ...
            <option value='<?php echo $ben_id ?>'><?php echo $account_name ?></option>
            ...
            <a href="addbeneficiary.php" class="text-blue-500 text-sm font-thin">Add Beneficiary</a>
          </div>
        </div>
    ...
    <button type="submit" name="quicktransfer" class="rounded-md w-full bg-blue-800 px-3 py-2 text-sm font-semibold text-white shadow-sm hover:bg-indigo-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600">Submit</button>
    </div>

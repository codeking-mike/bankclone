<?php
  ...
  $sql = "SELECT * FROM user_account WHERE user_id='$userid' AND account_type='savings' LIMIT 1";
        ...
        <section class="bg-blue-800 border-b-2 border-white">
            ...
            <div class="px-6 space-y-0 md:space-y-0 bg-blue-800 text-white">
                ...
                <div class="flex flex-col md:flex-col justify-between items-center py-6">
                    ...
                    <a href="#" class="md:px-8 px-5 py-1 md:max-w-sm text-blue-800 text-center bg-white baseline hover:bg-blue-600 "><i class="ri-arrow-left-right-fill h-12 w-12"></i>&nbsp;&nbsp;Card Controls</a>
